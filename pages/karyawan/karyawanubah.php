...
<div id="pesan" class="row mb-3">
    <div class="col">
        ...
        if (isset($_POST['simpan_button'])) {
            ...
            $updateSQL = "UPDATE karyawan SET  nama='$nama',
        ...
        <div class="card px-3 py-3">
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="id" name="nik" value="<?php echo $nik ?>" readonly>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="gaji_pokok" name="gaji_pokok"  value="<?php echo $row['nama'] ?>" required>
                </div>
                <div class="mb-3">
